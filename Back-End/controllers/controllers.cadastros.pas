  ...
  try
    try
       ...
       begin
           ...
           qryInserePessoa.ParamByName('NOME').AsString       := UTF8Decode(LJsonObj.Values['NOME'].AsString);
           qryInserePessoa.ParamByName('ENDERECO').AsString   := UTF8Decode(LJsonObj.Values['ENDERECO'].AsString);
           qryInserePessoa.ParamByName('CPF').AsString        := UTF8Decode(LJsonObj.Values['CPF'].AsString);
           ...
           qryInsereUsuario.ParamByName('USUARIO').AsString    := UTF8Decode(LJsonObj.Values['USUARIO'].AsString);
           qryInsereUsuario.ParamByName('SENHA').AsString      := UTF8Decode(LJsonObj.Values['SENHA'].AsString);
